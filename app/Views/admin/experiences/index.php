          ...
          <?php foreach($experiences as $experience): ?>
            <tr>
              ...
              <td>
                ...
                <form action="?p=admin.experiences.delete" method="post" style="display: inline;">
                  <input type="hidden" name="id" value="<?= $experience->id; ?>">
                  <button type="submit" href="?p=admin.experiences.delete&id=<?= $experience->id; ?>" class="button is-danger is-outlined"><i class="fas fa-trash"></i></button>
                </form>
              </td>
            </tr>
          <?php endforeach; ?>
